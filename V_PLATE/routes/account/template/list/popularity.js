//	템플릿 목록 ( 인기 )	/account/template/list/popularity
	...
	let task = [
		...
		function( connection , callback ) {
			...
			if( type === "all" ) {
				...
				selectTemplate = 'SELECT * FROM template ORDER BY template_hits DESC , template_uploadtime DESC' ;
				...
				selectTemplate = 'SELECT * FROM template WHERE template_type = ? ORDER BY template_hits DESC , template_uploadtime DESC' ;
