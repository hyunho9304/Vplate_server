//	mymedia 목록 ( 최신/미완성 )	/account/video/list/incompletion
	...
	let task = [
		...
		function( list , callback ) {
			...
			res.status(200).send({
				...
				msg: "successfully get mymedia incompletion lists"
			});
			callback ( null , "successfully get mymedia incompletion lists" ) ;
		}
	] ;
